...
>[!TIP]
>
>如果您更喜欢&#x200B;**通过实践**&#x200B;学习并有技术倾向，请访问AEM Headless教程，这些教程按API和框架组织，可在本文档末尾的[其他资源部分](#additional-resources)中找到。
...
| 2 | [AEM Headless快速入门](getting-started.md) | 了解 AEM Headless 前提条件 |
...
| 9 | [可选 – 如何使用 AEM 创建单页应用程序 (SPA)](create-spa.md) | 了解AEM的Headless功能后，可探索如何将Headless交付与Headless交付结合使用，并了解如何使用AEM的SPA Editor框架创建可编辑SPA。 |
