...
管理员配置用户后，将授予他们访问所有AEM资源的权限，以便他们作为参与者完成使用AEM Headless交付Experience应用程序的工作。
...
* [多 Site 管理器和翻译](/help/sites-administering/msm-and-translation.md) – 有关 AEM 的强大翻译功能的技术文档
