...
+ 安全性 {#security}
  ...
  + [相同网站 Cookie 支持](/help/sites-administering/same-site-cookie-support.md)
...
+ Sites {#sites}
  + 创作 {#authoring}
    ...
    + 页面性能 {#page-performance}
      + [内容洞察](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/authoring/siteandpage/content-insights.html?lang=zh-Hans)
  ...
  + 管理 {#administering}
    ...
    + 个性化 {#personalization}
      ...
      + [配置 ContextHub](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/personlization/ch-configuring.html?lang=zh-Hans)
    ...
    + 最佳做法 {#bestpractices}
      ...
      + [翻译最佳做法](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/administering/introduction/tc-bp.html?lang=zh-Hans)
      + [MSM 最佳实践](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/administering/introduction/msm-best-practices.html?lang=zh-Hans)
      + [AEM Sites - GDPR 就绪](/help/sites-administering/gdpr-compliance-sites.md)
      + [处理 AEM Foundation 的 GDPR 请求](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/security/handling-gdpr-requests-for-aem-platform.html?lang=zh-Hans)
...
+ Forms {#forms}
  + [AEM Forms 服务包热修复](/help/forms/using/adobe-experience-manager-forms-65-lts-hotfixes.md)
  ...
  + 安装和配置 AEM Forms {#install-aem-forms}
    ...
    + [适用于AEM Forms on JEE的安装和升级工作流](/help/forms/using/aem-forms-jee-installation-upgrade-documentation.md)
    + 安装 JEE 上的 AEM Forms {#jee-installation}
      + [JEE 上的 AEM Forms 支持的平台](/help/forms/using/aem-forms-jee-supported-platforms.md)
      + [准备安装AEM Forms（单服务器）](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-install-single-server.pdf)
      + [在JEE上使用JBoss Turnkey安装和部署AEM Forms 6.5 LTS](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/install-turnkey.pdf)
      + [在JEE for JBoss上安装和部署AEM Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/install-jboss.pdf)
      + [在JEE上安装和部署AEM Forms for WebSphere Liberty配置文件](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/install-websphere.pdf)
      + [正在准备安装AEM Forms (Cluster Server)](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-install-cluster.pdf)
      + [在JBoss集群上的JEE上配置AEM Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/cluster-jboss.pdf)
      + [在WebSphere Liberty配置文件群集上配置JEE上的AEM Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/cluster-websphere.pdf)
      + [Database Credential Store安装指南（独立模式）](/help/forms/using/database-credentials-store-setup-guide-standalone-mode.md)
      + [数据库凭据存储设置（基于Elytron）](/help/forms/using/database-credential-store-setup-elytron-based.md)
      + [辅助节点身份验证设置（基于Elytron）](/help/forms/using/secondary-node-authentication-setup-elytron-based.md)
    ...
    + 配置 AEM Forms {#configure-aem-forms}
      ...
      + {hide-from-toc}[将AEM Forms配置为将表单数据提交到JEE上的AEM Forms](/help/forms/using/submit-form-data-livecycle-process.md)
  ...
  + 升级 AEM Forms {#upgrade-aem-forms}
    ...
    + 在 OSGi 上升级 AEM Forms {#aem-forms-osgi-upgrade}
      ...
      + [在JBoss EAP 8上升级AEM 6.5 LTS (Windows)](/help/forms/using/upgrading-aem-65-lts-on-jboss-eap-8.md)
    + 升级 JEE 上的 AEM Forms {#aem-forms-jee-upgrade}
      + [准备升级AEM Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-upgrade.pdf)
      + [在JEE上升级到AEM Forms 6.5 LTS for JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-turnkey.pdf)
      + [在JEE上升级到AEM Forms for JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-jboss.pdf)
      + [在JEE上升级到AEM Forms for WebSphere Liberty配置文件](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-websphere.pdf)
  + 管理 AEM Forms {#manage-administer-aem-forms}
    ...
    + [下载 XFA 或 PDF 表单模板](/help/forms/using/download-xfa-or-pdf-form.md)
  ...
  + 工作流 {#workflows}
    ...
    + {hide-from-toc}[OSGi和AEM Forms JEE工作流中表单中心的AEM工作流的操作和功能](/help/forms/using/capabilities-osgi-jee-workflows.md)
  ...
  + AEM Forms 应用程序 {#aem-forms-app}
    ...
    + [设置™ studio项目并构建Android™应用程序](/help/forms/using/setup-android-studio-project-build-installer.md)
    + [构建AEM Forms Android™应用程序](/help/forms/using/setup-eclipse-project-build-installer.md)
  ...
  + 事务报告 {#transaction-reports}
    ...
    + OSGi 上的 AEM Forms 的事务报告 {#transaction-reports-osgi}
      ...
      + {hide-from-toc}[启用和查看交易报告](/help/forms/using/transaction-report-overview-jee.md)
      + {hide-from-toc}[JEE上AEM Forms的可计费API列表](/help/forms/using/transaction-reports-billable-apis-jee.md)
      + {hide-from-toc}[记录自定义组件API的事务](/help/forms/using/record-transaction-custom-component-jee.md)
  + JEE 上的 AEM Forms 的管理员帮助 {#administrator-help}
    + 开始使用 {#get-started}
      + {hide-from-toc}[常规AEM Forms设置](/help/forms/using/admin-help/configure-general-aem-forms-settings.md)
      + {hide-from-toc}[更新部署的许可证类型](/help/forms/using/admin-help/update-license-type-deployment.md)
    + 设置和管理域 {#setup-manage-domains}
      + {hide-from-toc}[正在添加域](/help/forms/using/admin-help/adding-domains.md)
      + {hide-from-toc}[删除域](/help/forms/using/admin-help/delete-domain.md)
      + {hide-from-toc}[配置帐户锁定设置](/help/forms/using/admin-help/configure-account-locking-settings.md)
      + {hide-from-toc}[编辑和转换现有域](/help/forms/using/admin-help/editing-converting-existing-domains.md)
      + {hide-from-toc}[正在配置身份验证提供程序](/help/forms/using/admin-help/configuring-authentication-providers.md)
      + {hide-from-toc}[正在同步目录](/help/forms/using/admin-help/synchronizing-directories.md)
      + {hide-from-toc}[配置目录](/help/forms/using/admin-help/configuring-directories.md)
    + 配置用户管理 {#configure-user-management}
      + {hide-from-toc}[更改身份验证的评估顺序](/help/forms/using/admin-help/change-order-evaluation-authentication.md)
      + {hide-from-toc}[配置LDAP绑定密码](/help/forms/using/admin-help/configure-ldap-bind-password.md)
      + {hide-from-toc}[配置AEM表单以预取域信息](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
      + {hide-from-toc}[正在配置基于证书的身份验证](/help/forms/using/admin-help/configuring-certificate-based-authentication.md)
      + {hide-from-toc}[配置SAML服务提供程序设置](/help/forms/using/admin-help/configure-saml-service-provider-settings.md)
      + {hide-from-toc}[在AEM表单中启用单点登录](/help/forms/using/admin-help/enabling-single-sign-on-aem.md)
      + {hide-from-toc}[为启用了SSL的LDAP服务器配置用户管理](/help/forms/using/admin-help/configure-user-management-ssl-enabled.md)
      + {hide-from-toc}[导入和导出配置文件](/help/forms/using/admin-help/importing-exporting-configuration-file.md)
      + {hide-from-toc}[配置高级系统属性](/help/forms/using/admin-help/configure-advanced-system-attributes.md)
      + {hide-from-toc}[阻止CSRF攻击](/help/forms/using/admin-help/preventing-csrf-attacks.md)
    + 设置和组织用户 {#setup-organize-users}
      + {hide-from-toc}[添加和配置用户](/help/forms/using/admin-help/adding-configuring-users.md)
      + {hide-from-toc}[Just-in-time用户设置](/help/forms/using/admin-help/just-in-time-user-provisioning.md)
      + {hide-from-toc}[正在创建和配置组](/help/forms/using/admin-help/creating-configuring-groups.md)
      + {hide-from-toc}[搜索用户或组](/help/forms/using/admin-help/search-user-or-group.md)
      + {hide-from-toc}[正在创建和配置角色](/help/forms/using/admin-help/creating-configuring-roles.md)
    + 连接到内容管理系统 {#connect-content-management-system}
      + {hide-from-toc}[为EMC Documentum配置连接器®](/help/forms/using/admin-help/configuring-connector-emc-documentum.md)
      + {hide-from-toc}[配置® FileNet的连接器](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
      + {hide-from-toc}[为® Content Manager配置连接器](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
      + {hide-from-toc}[配置Microsoft SharePoint的连接器](/help/forms/using/admin-help/configuring-connector-microsoft-sharepoint.md)
    + 管理证书和凭据 {#manage-certificates-credentials}
      + {hide-from-toc}[添加和删除用户名和密码凭据](/help/forms/using/admin-help/adding-removing-user-name-password.md)
      + {hide-from-toc}[管理证书吊销列表](/help/forms/using/admin-help/certificate-revocation-lists.md)
      + {hide-from-toc}[管理证书和凭据的基础知识](/help/forms/using/admin-help/overview-2.md)
      + {hide-from-toc}[管理证书](/help/forms/using/admin-help/certificates.md)
      + {hide-from-toc}[管理HSM凭据](/help/forms/using/admin-help/hsm-credentials.md)
      + {hide-from-toc}[管理本地凭据](/help/forms/using/admin-help/local-credentials.md)
    + 导入和管理应用程序与归档文件 {#import-manage-applications-archives}
      + {hide-from-toc}[更改应用程序和服务页面上显示的项目数](/help/forms/using/admin-help/change-number-items-displayed-applications.md)
      + {hide-from-toc}[导入和管理存档](/help/forms/using/admin-help/import-archives.md)
      + {hide-from-toc}[导入和管理应用程序](/help/forms/using/admin-help/import-applications.md)
    + 管理服务 {#manage-services}
      + {hide-from-toc}[配置服务设置](/help/forms/using/admin-help/configure-service-settings.md)
      + {hide-from-toc}[正在启动和停止服务](/help/forms/using/admin-help/starting-stopping-services.md)
    + 管理端点 {#manage-endpoints}
      + {hide-from-toc}[添加、启用、修改或删除端点](/help/forms/using/admin-help/adding-enabling-modifying-or-removing.md)
      + {hide-from-toc}[配置电子邮件端点](/help/forms/using/admin-help/configuring-email-endpoints.md)
      + {hide-from-toc}[配置oAuth2.0身份验证](/help/forms/using/oauth2-support-for-mail-service.md)
      + {hide-from-toc}[配置远程端点](/help/forms/using/admin-help/configuring-remoting-endpoints.md)
      + {hide-from-toc}[配置观察文件夹端点](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
      + {hide-from-toc}[配置任务管理器端点](/help/forms/using/admin-help/configuring-task-manager-endpoints.md)
      + {hide-from-toc}[终结点类型](/help/forms/using/admin-help/types-endpoints.md)
    + 配置Acrobat Reader DC扩展 {#configure-acrobat-reader-dc-extensions}
      + {hide-from-toc}[Acrobat Reader DC扩展使用的证书类型](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
      + {hide-from-toc}[识别PDF文档中的有效证书和过期证书](/help/forms/using/admin-help/recognizing-valid-expired-certificates-pdf.md)
      + {hide-from-toc}[为数据捕获配置Acrobat Reader DC扩展](/help/forms/using/admin-help/configuring-acrobat-reader-dc-extensions.md)
      + {hide-from-toc}[查看凭据使用信息](/help/forms/using/admin-help/review-credential-information.md)
      + {hide-from-toc}[配置凭据以用于Acrobat Reader DC扩展](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
      + {hide-from-toc}[查看PDF文件的使用权限](/help/forms/using/admin-help/review-usage-rights-pdf-file.md)
      + {hide-from-toc}[启用Adobe Reader Web浏览器插件的联机注释](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
      + {hide-from-toc}[设置超时值以用于Acrobat Reader DC扩展](/help/forms/using/admin-help/setting-timeout-values-acrobat-reader.md)
      + {hide-from-toc}[正在更新过期的Reader扩展服务证书](/help/forms/using/admin-help/updating-expired-reader-extension-certificates.md)
    + 使用 PDF Generator {#work-with-pdf-generator}
      + {hide-from-toc}[使用PDF Generator简介](/help/forms/using/admin-help/overview-5.md)
      + {hide-from-toc}[正在启用多线程文件转换](/help/forms/using/admin-help/enabling-multi-threaded-file-conversions.md)
      + {hide-from-toc}[正在配置Adobe PDF设置](/help/forms/using/admin-help/configuring-pdf-settings.md)
      + {hide-from-toc}[正在配置安全设置](/help/forms/using/admin-help/configuring-security-settings.md)
      + {hide-from-toc}[正在配置文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings.md)
      + {hide-from-toc}[导入和导出PDF Generator配置文件](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md)
      + {hide-from-toc}[启用PDF/A支持](/help/forms/using/admin-help/enable-pdf-a-support.md)
      + {hide-from-toc}[正在设置PDFG网络打印机（仅限Windows）](/help/forms/using/admin-help/setting-pdfg-network-printer-windows.md)
      + {hide-from-toc}[配置回退字体](/help/forms/using/admin-help/configuring-fallback-fonts.md)
      + {hide-from-toc}[修改PDF导出转换设置](/help/forms/using/admin-help/modifying-pdf-export-conversion-settings.md)
      + {hide-from-toc}[使用PDF Generator转换文件](/help/forms/using/admin-help/converting-files-using-pdf-generator.md)
    + 配置 SSL {#configure-ssl}
      + {hide-from-toc}[配置SSL概述](/help/forms/using/admin-help/overview-6.md)
      + [为JBoss®应用程序服务器配置SSL](/help/forms/using/admin-help/configuring-ssl-for-jboss-application-server-aem-forms-65-lts-jee.md)
      + {hide-from-toc}[在Windows Vista上配置SSL](/help/forms/using/admin-help/configuring-ssl-windows-vista.md)
      + {hide-from-toc}[为WebSphere®应用程序服务器配置SSL](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
    + 使用文档安全功能 {#work-with-document-security}
      + {hide-from-toc}[关于Document Security](/help/forms/using/admin-help/document-security.md)
      + {hide-from-toc}[高容量安全信息传递](/help/forms/using/admin-help/high-volume-secure-information-delivery.md)
      + {hide-from-toc}[正在配置客户端和服务器选项](/help/forms/using/admin-help/configuring-client-server-options.md)
      + {hide-from-toc}[管理受邀的用户帐户和本地用户帐户](/help/forms/using/admin-help/invited-local-user-accounts.md)
      + {hide-from-toc}[控制对受策略保护文档的访问](/help/forms/using/admin-help/controlling-access-policy-protected-documents.md)
      + {hide-from-toc}[正在监视事件](/help/forms/using/admin-help/monitoring-events.md)
      + {hide-from-toc}[创建和管理策略](/help/forms/using/admin-help/creating-policies.md)
      + {hide-from-toc}[使用Document Security网页](/help/forms/using/admin-help/using-document-security-web-pages.md)
      + {hide-from-toc}[创建和管理策略集](/help/forms/using/admin-help/creating-policy-sets.md)
      + {hide-from-toc}[注册为用户](/help/forms/using/admin-help/registering-as-a-user.md)
    + 配置表单 {#configure-forms}
      + {hide-from-toc}[配置表单的基础知识](/help/forms/using/admin-help/overview-7.md)
      + {hide-from-toc}[设置国际化选项](/help/forms/using/admin-help/setting-internationalization-options.md)
      + {hide-from-toc}[配置Forms的缓存](/help/forms/using/admin-help/configuring-caching-forms.md)
      + {hide-from-toc}[指定XCI配置选项](/help/forms/using/admin-help/specifying-xci-configuration-options.md)
      + {hide-from-toc}[配置表单输出](/help/forms/using/admin-help/configuring-form-output.md)
      + {hide-from-toc}[指定要嵌入的字体](/help/forms/using/admin-help/specifying-fonts-embed.md)
      + {hide-from-toc}[配置Forms的位置](/help/forms/using/admin-help/configuring-locations-forms.md)
      + {hide-from-toc}[指定安全设置](/help/forms/using/admin-help/specifying-security-settings.md)
      + {hide-from-toc}[正在配置验证消息](/help/forms/using/admin-help/configuring-validation-messages.md)
    + 配置输出 {#configure-output}
      + {hide-from-toc}[输出服务概述](/help/forms/using/admin-help/overview-8.md)
      + {hide-from-toc}[指定XCI配置](/help/forms/using/admin-help/specify-xci-configuration-options.md)
      + {hide-from-toc}[正在配置输出的缓存](/help/forms/using/admin-help/configuring-caching-output.md)
      + {hide-from-toc}[指定输出的文件位置](/help/forms/using/admin-help/specify-file-locations-output.md)
      + {hide-from-toc}[使字体可用](/help/forms/using/admin-help/make-fonts-available.md)
      + {hide-from-toc}[指定要嵌入的字体](/help/forms/using/admin-help/specify-fonts-embed.md)
      + {hide-from-toc}[指定安全设置](/help/forms/using/admin-help/specify-security-settings.md)
      + {hide-from-toc}[更改字符集](/help/forms/using/admin-help/change-character-set.md)
    + 配置Forms Workflow{#configure-forms-workflow}
      + {hide-from-toc}[关于管理和流程术语](/help/forms/using/admin-help/administration-process-terminology.md)
      + {hide-from-toc}[管理进程](/help/forms/using/admin-help/processes.md)
      + {hide-from-toc}[配置商务日历](/help/forms/using/admin-help/configuring-business-calendars.md)
      + {hide-from-toc}[Forms Workflow概述](/help/forms/using/admin-help/overview-9.md)
      + {hide-from-toc}[配置外出设置](/help/forms/using/admin-help/configuring-out-office-settings.md)
      + {hide-from-toc}[正在搜索进程实例](/help/forms/using/admin-help/searching-process-instances.md)
      + {hide-from-toc}[正在配置服务器设置](/help/forms/using/admin-help/configuring-server-settings.md)
      + {hide-from-toc}[处理停止的操作和分支](/help/forms/using/admin-help/stalled-operations-branches.md)
      + {hide-from-toc}[配置共享队列](/help/forms/using/admin-help/configuring-shared-queues.md)
      + {hide-from-toc}[处理任务](/help/forms/using/admin-help/tasks.md)
    + 配置工作区 {#configure-workspace}
      + {hide-from-toc}[Workspace概述](/help/forms/using/admin-help/overview-10.md)
      + {hide-from-toc}[导入和导出全局设置](/help/forms/using/admin-help/importing-exporting-global-settings.md)
      + {hide-from-toc}[设置当天消息](/help/forms/using/admin-help/setting-message-day.md)
      + {hide-from-toc}[自定义搜索模板](/help/forms/using/admin-help/customizing-search-templates.md)
      + {hide-from-toc}[管理Workspace中显示的类别](/help/forms/using/admin-help/categories-displayed-workspace.md)
    + 运行状况监控 {#health-monitor}
      + {hide-from-toc}[运行状况监视器概述](/help/forms/using/admin-help/overview-11.md)
      + {hide-from-toc}[正在微调运行状况监视器性能](/help/forms/using/admin-help/fine-tuning-health-monitor-performance.md)
      + {hide-from-toc}[查看与工作管理器相关的统计信息](/help/forms/using/admin-help/view-statistics-related-manager.md)
      + {hide-from-toc}[查看系统信息](/help/forms/using/admin-help/view-system-information.md)
      + {hide-from-toc}[清除作业管理器数据库中的记录](/help/forms/using/admin-help/purge-records-job-manager-database.md)
    + 维护 AEM Forms {#maintain-aem-forms}
      + {hide-from-toc}[日志文件](/help/forms/using/admin-help/log-files.md)
      + {hide-from-toc}[用户管理](/help/forms/using/admin-help/user-management.md)
      + {hide-from-toc}[监控AEM表单部署](/help/forms/using/admin-help/monitoring-aem-forms-deployments.md)
      + {hide-from-toc}[工作管理器和节流](/help/forms/using/admin-help/manager-throttling.md)
      + {hide-from-toc}[在维护模式下运行AEM表单](/help/forms/using/admin-help/running-aem-forms-maintenance-mode.md)
    + 维护 AEM Forms 数据库 {#maintain-aem-forms-database}
      + {hide-from-toc}[DB2®数据库：每周运行一个进程](/help/forms/using/admin-help/db2-database-running-process-weekly.md)
      + {hide-from-toc}[Oracle数据库最大打开游标阈值](/help/forms/using/admin-help/oracle-database-maximum-open-cursors.md)
      + {hide-from-toc}[® DB2®数据库：正在运行用于定期维护的命令](/help/forms/using/admin-help/ibm-db2-database-running-commands.md)
      + {hide-from-toc}[正在清除进程数据](/help/forms/using/admin-help/purging-process-data.md)
      + {hide-from-toc}[Microsoft SQL Server数据库：正在微调配置](/help/forms/using/admin-help/microsoft-sql-server-database-fine.md)
      + {hide-from-toc}[最大程度地减少数据库增长的技巧](/help/forms/using/admin-help/tips-minimizing-database-growth.md)
    + 维护应用程序服务器 {#manage-application-server}
      + {hide-from-toc}[应用程序服务器网站](/help/forms/using/admin-help/application-server-websites.md)
      + {hide-from-toc}[全局文档存储目录](/help/forms/using/admin-help/global-document-storage-directory.md)
      + {hide-from-toc}[运行AdministrationConsole时的注意事项](/help/forms/using/admin-help/considerations-running-administration-console.md)
      + {hide-from-toc}[增强应用程序服务器性能](/help/forms/using/admin-help/enhancing-application-server-performance.md)
      + {hide-from-toc}[正在启动和停止WebSphere®应用程序服务器](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
    + AEM Forms 备份与恢复 {#aem-forms-backup-recovery}
      + {hide-from-toc}[备份和恢复EMC Documentum®存储库](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
      + {hide-from-toc}[正在启用和禁用安全备份模式](/help/forms/using/admin-help/enabling-disabling-safe-backup-mode.md)
      + {hide-from-toc}[正在备份AEM表单数据](/help/forms/using/admin-help/backing-aem-forms-data.md)
      + {hide-from-toc}[要备份和恢复的文件](/help/forms/using/admin-help/files-back-recover.md)
      + {hide-from-toc}[AEM表单的备份和恢复策略](/help/forms/using/admin-help/backup-recovery-strategy-aem-forms.md)
      + {hide-from-toc}[PDF Generator备份限制](/help/forms/using/admin-help/pdf-generator-backup-limitations.md)
      + {hide-from-toc}[监视文件夹的备份策略](/help/forms/using/admin-help/backup-strategies-watched-folders.md)
      + [恢复 AEM Forms 数据](/help/forms/using/admin-help/recovering-aem-forms-data.md)
      + [针对EMC Documentum®用户的Connector备份战略](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
      + {hide-from-toc}[在群集环境中备份和还原的策略](/help/forms/using/admin-help/strategy-backup-restore-clustered-environment.md)
    + 系统信息服务 {#system-information-service}
      + {hide-from-toc}[设置系统信息服务](/help/forms/using/admin-help/set-system-information-service.md)
      + {hide-from-toc}[系统信息服务API](/help/forms/using/admin-help/system-information-service-apis.md)
  ...
  + 开发人员参考 {#developer-reference}
    ...
    + [HTML5 表单的 Form Bridge API](/help/forms/using/form-bridge-apis.md)
    ...
    + 使用 JEE 上的 AEM Forms 进行编程 {#programming-aem-forms-jee}
      + JEE 上的 AEM Forms 编程简介 {#introduction-programming-aem-forms-jee}
        + {hide-from-toc}[Java API快速入门简介](/help/forms/developing/introducing-java-api-soap-quick.md)
        + {hide-from-toc}[使用API调用AEM Forms](/help/forms/developing/invoking-aem-forms-using-apis.md)
        + {hide-from-toc}[了解AEM Forms流程](/help/forms/developing/aem-forms-processes.md)
        + {hide-from-toc}[服务容器](/help/forms/developing/service-container.md)
      + 为 AEM Forms 开发 SPI {#developing-spis-aem-forms}
        + {hide-from-toc}[创建邀请外部用户处理程序](/help/forms/developing/creating-invite-external-users-handler.md)
      + Java API 快速入门——代码示例 {#java-api-quick-start-code-examples}
        + {hide-from-toc}[应用程序管理器客户端JavaAPI快速入门(SOAP)](/help/forms/developing/application-manager-client-java-api.md)
        + {hide-from-toc}[应用程序管理器服务JavaAPI快速入门(SOAP)](/help/forms/developing/application-manager-service-java-api.md)
        + {hide-from-toc}[汇编程序服务Java API快速启动(SOAP)](/help/forms/developing/assembler-service-java-api-quick.md)
        + {hide-from-toc}[Acrobat Reader DC扩展服务Java API快速入门(SOAP)](/help/forms/developing/acrobat-reader-dc-extensions-service.md)
        + {hide-from-toc}[备份和还原服务APIQuick开始](/help/forms/developing/backup-restore-service-api-quick.md)
        + {hide-from-toc}[条码式Forms服务Java APIQuick Start(SOAP)](/help/forms/developing/barcoded-forms-service-java-api.md)
        + {hide-from-toc}[组件和服务Java APIQuick Start(SOAP)](/help/forms/developing/components-services-java-api-quick.md)
        + {hide-from-toc}[转换PDF服务Java API快速入门(SOAP)](/help/forms/developing/convert-pdf-service-java-api.md)
        + {hide-from-toc}[凭据服务Java API快速启动(SOAP)](/help/forms/developing/credential-service-java-api-quick.md)
        + {hide-from-toc}[Distiller服务Java API快速入门(SOAP)](/help/forms/developing/distiller-service-java-api-quick.md)
        + {hide-from-toc}[DocConverter服务Java API快速启动(SOAP)](/help/forms/developing/docconverter-service-java-api-quick.md)
        + {hide-from-toc}[文档管理服务（已弃用）Java API快速入门(SOAP)](/help/forms/developing/document-management-service-deprecated-java.md)
        + {hide-from-toc}[Document Security Service JavaAPI快速入门(SOAP)](/help/forms/developing/document-security-service-java-api.md)
        + {hide-from-toc}[加密服务Java API快速启动(SOAP)](/help/forms/developing/encryption-service-java-api-quick.md)
        + {hide-from-toc}[终结点注册表Java API快速启动(SOAP)](/help/forms/developing/endpoint-registry-java-api-quick.md)
        + {hide-from-toc}[表单数据集成服务JavaAPI快速入门(SOAP)](/help/forms/developing/form-data-integration-service-java.md)
        + {hide-from-toc}[Forms服务API快速启动](/help/forms/developing/forms-service-api-quick-starts.md)
        + {hide-from-toc}[生成PDF服务Java API快速启动(SOAP)](/help/forms/developing/generate-pdf-service-java-api.md)
        + {hide-from-toc}[调用API快速启动](/help/forms/developing/invocation-api-quick-starts.md)
        + {hide-from-toc}[LiveCycleProcess Java API(SOAP)快速入门](/help/forms/developing/livecycleprocess-java-api-soap-quick.md)
        + {hide-from-toc}[输出服务Java API快速入门(SOAP)](/help/forms/developing/output-service-java-api-quick.md)
        + {hide-from-toc}[PDF实用工具服务Java APIQuick Start(SOAP)](/help/forms/developing/pdf-utilities-service-java-api.md)
        + {hide-from-toc}[存储库服务API快速启动](/help/forms/developing/repository-service-api-quick-starts.md)
        + {hide-from-toc}[签名服务Java API快速启动(SOAP)](/help/forms/developing/signature-service-java-api-quick.md)
        + {hide-from-toc}[任务管理器服务Java API快速启动(SOAP)](/help/forms/developing/task-manager-service-java-api.md)
        + {hide-from-toc}[用户管理器Java API快速入门(SOAP)](/help/forms/developing/user-manager-java-api-quick.md)
        + {hide-from-toc}[XMP实用工具服务Java APIQuick Start(SOAP)](/help/forms/developing/xmp-utilities-service-java-api.md)
      + 使用 API 调用 JEE 上的 AEM Forms {#invoking-aem-forms-jee-apis}
        + {hide-from-toc}[使用REST请求调用AEM Forms](/help/forms/developing/invoking-aem-forms-using-rest.md)
        + {hide-from-toc}[使用Web服务调用AEM Forms](/help/forms/developing/invoking-aem-forms-using-web.md)
        + {hide-from-toc}[使用远程调用调用AEM Forms](/help/forms/developing/invoking-aem-forms-using-remoting.md)
        + {hide-from-toc}[使用Web服务调用AEM Forms](/help/forms/developing/invoking-human-centric-long-lived.md)
        + {hide-from-toc}[使用JavaAPI调用AEM Forms](/help/forms/developing/invoking-aem-forms-using-java.md)
        + {hide-from-toc}[创建使用HTTP令牌执行SSO身份验证的Flash Builder应用程序](/help/forms/developing/creating-flash-builder-applications-perform.md)
      + 使用 API 执行服务操作 {#performing-service-operations-using-apis}
        + {hide-from-toc}[使用API执行服务操作](/help/forms/developing/performing-service-operations-using-apis.md)
        + {hide-from-toc}[呈现Forms](/help/forms/developing/rendering-forms.md)
        + {hide-from-toc}[装配PDF文档](/help/forms/developing/assembling-pdf-documents.md)
        + {hide-from-toc}[以编程方式组合PDF文档](/help/forms/developing/programmatically-assembling-pdf-documents.md)
        + {hide-from-toc}[在文件格式和PDF之间进行转换](/help/forms/developing/converting-file-formats-pdf.md)
        + {hide-from-toc}[以编程方式分解PDF文档](/help/forms/developing/programmatically-disassembling-pdf-documents.md)
        + {hide-from-toc}[汇编加密的PDF文档](/help/forms/developing/assembling-encrypted-pdf-documents.md)
        + {hide-from-toc}[组合多个XDP片段](/help/forms/developing/assembling-multiple-xdp-fragments.md)
        + {hide-from-toc}[使用Bates编号组装文档](/help/forms/developing/assembling-documents-using-bates-numbering.md)
        + {hide-from-toc}[汇编非交互式PDF文档](/help/forms/developing/assembling-non-interactive-pdf-documents.md)
        + {hide-from-toc}[组合带有书签的PDF文档](/help/forms/developing/assembling-pdf-documents-bookmarks.md)
        + {hide-from-toc}[正在分配使用权限](/help/forms/developing/assigning-usage-rights.md)
        + {hide-from-toc}[装配PDF项目组合](/help/forms/developing/assembling-pdf-portfolios.md)
        + {hide-from-toc}[正在计算表单数据](/help/forms/developing/calculating-form-data.md)
        + {hide-from-toc}[创建呈现Forms的Web应用程序](/help/forms/developing/creating-web-applications-renders-forms.md)
        + {hide-from-toc}[创建包含SubmittedXML数据的PDF文档](/help/forms/developing/creating-pdf-documents-submitted-xml.md)
        + {hide-from-toc}[使用Web服务API拆分PDF文档](/help/forms/developing/disassemble-pdf-document-using-web.md)
        + {hide-from-toc}[确定文档是否符合PDF/A标准](/help/forms/developing/determining-whether-documents-pdf-a.md)
        + {hide-from-toc}[动态创建DDX文档](/help/forms/developing/dynamically-creating-ddx-documents.md)
        + {hide-from-toc}[处理提交的Forms](/help/forms/developing/handling-submitted-forms.md)
        + {hide-from-toc}[优化Forms服务的性能](/help/forms/developing/optimizing-performance-forms-service.md)
        + {hide-from-toc}[将文档传递到FormsService](/help/forms/developing/passing-documents-forms-service.md)
        + {hide-from-toc}[使用可流动布局预填充Forms](/help/forms/developing/prepopulating-forms-flowable-layouts.md)
        + {hide-from-toc}[根据片段渲染Forms](/help/forms/developing/rendering-forms-based-fragments.md)
        + {hide-from-toc}[按值呈现Forms](/help/forms/developing/rendering-forms-value.md)
        + {hide-from-toc}[将Forms渲染为HTML](/help/forms/developing/rendering-forms-html.md)
        + {hide-from-toc}[在客户端渲染Forms](/help/forms/developing/rendering-forms-client.md)
        + {hide-from-toc}[使用自定义CSS文件呈现HTML Forms](/help/forms/developing/rendering-html-forms-using-custom.md)
        + {hide-from-toc}[使用CustomToolbars呈现HTML Forms](/help/forms/developing/rendering-html-forms-custom-toolbars.md)
        + {hide-from-toc}[渲染交互式PDF forms](/help/forms/developing/rendering-interactive-pdf-forms.md)
        + {hide-from-toc}[渲染启用权限的Forms](/help/forms/developing/rendering-rights-enabled-forms.md)
        + {hide-from-toc}[验证DDX文档](/help/forms/developing/validating-ddx-documents.md)
        + {hide-from-toc}[将PDF转换为Postscript和Image文件](/help/forms/developing/converting-pdf-postscript-image-files.md)
        + {hide-from-toc}[将Postscript转换为PDF文档](/help/forms/developing/converting-postscript-pdf-documents.md)
        + {hide-from-toc}[创建文档输出流](/help/forms/developing/creating-document-output-streams.md)
        + {hide-from-toc}[对文档进行数字签名和认证](/help/forms/developing/digitally-signing-certifying-documents.md)
        + {hide-from-toc}[加密和解密PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md)
        + {hide-from-toc}[导入和导出数据](/help/forms/developing/importing-exporting-data.md)
        + {hide-from-toc}[管理用户](/help/forms/developing/users.md)
        + {hide-from-toc}[使用AEM Forms存储库](/help/forms/developing/aem-forms-repository.md)
        + {hide-from-toc}[使用条形码Forms](/help/forms/developing/barcoded-forms.md)
        + {hide-from-toc}[使用凭据](/help/forms/developing/credentials.md)
        + {hide-from-toc}[使用PDF/A文档](/help/forms/developing/pdf-a-documents.md)
        + {hide-from-toc}[使用PDF实用工具](/help/forms/developing/pdf-utilities.md)
        + {hide-from-toc}[使用XMP实用工具](/help/forms/developing/xmp-utilities.md)
        + {hide-from-toc}[正在准备AEM Forms以进行备份](/help/forms/developing/preparing-aem-forms-backup.md)
        + {hide-from-toc}[以编程方式管理端点](/help/forms/developing/programmatically-endpoints.md)
        + {hide-from-toc}[以编程方式管理首选项节点](/help/forms/developing/programmatically-preferences-nodes.md)
        + {hide-from-toc}[使用策略保护文档](/help/forms/developing/protecting-documents-policies.md)
        + {hide-from-toc}[使用Web服务API验证DDX文档](/help/forms/developing/validate-ddx-document-using-web.md)
  + 疑难解答 {#troubleshooting}
    + [在某些版本的 Oracle JDK 上无法使用部分表单功能](/help/forms/using/unable-to-use-forms-features-with-certain-versions-of-oracle-jdk.md)
    + {hide-from-toc}[获取JEE版自适应Forms的带附件的电子邮件的其他步骤](/help/forms/using/additional-steps-to-use-email-with-attachments.md)
    + {hide-from-toc}[无法将Word或Excel文件转换为Windows Server上的PDF](/help/forms/using/disable-uac-for-pdfgconfiguration.md)
    + {hide-from-toc}[无法在Google Chrome、Firefox、Microsoft Edge、Microsoft Internet Explorer或Apple Safari中打开基于XFA的PDF forms](/help/forms/using/xfa-based-forms-in-chrome-firefox-ie-internet-explorter-safari-edge.md)
    + {hide-from-toc}[无法还原CRX存储库](/help/forms/using/restore-crx-repository.md)
    + {hide-from-toc}[正在处理文档，即使AEM Forms服务器未完全启动并正在运行](/help/forms/using/processing-documents-even-if-aem-forms-server-not-fully-up.md)
    + {hide-from-toc}[无法使用输出服务、Forms服务或记录文档(DoR)服务](/help/forms/using/connection-issues-with-output-forms-and-document-of-record-dor-services.md)
    + {hide-from-toc}[PDF生成无法在WorkBench上打印大量PDF](/help/forms/using/pdf-generation-service-fails-to-print-a-large-number-of-pdfs-on-workbench.md)
    + {hide-from-toc}[如何正确重新启动AEM SDK](/help/forms/using/restart-aem-sdk.md)
    ...
    + [AEM Forms阻止有效的HTTP请求](/help/forms/troubleshooting/aem-forms-blocks-valid-http-requests.md)
  + 旧版文档 {#legacy-documentation}
    ...
    + {hide-from-toc}[在JEE服务器群集上配置AEM Forms并进行故障排除](/help/forms/developing/configure-server-cluster.md)
    + {hide-from-toc}[在动态PDF forms中生成和使用哈希](/help/forms/developing/hashing-forms.md)
    + {hide-from-toc}[使用WS-Security标头传递凭据](/help/forms/developing/passing-credentials.md)
+ AEM 中的 AI {#ai-in-aem}
...
+ 内容和 Commerce {#commerce}
  ...
  + 集成 {#integrations}
    ...
    + [第三方Commerce解决方案](/help/commerce/cif/integrating/third-party.md)
  + AEM 店面 {#storefront}
...
+ 实施 {#implementing}
  + 开发 {#developing}
    ...
    + 组件{#components}
      ...
      + [样式系统](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/authoring/siteandpage/style-system.html?lang=zh-Hans)
    ...
    + Headless 体验管理 {#headless}
      ...
      + Headless 历程 {#journeys}
        + Headless 开发人员历程 {#developer}
          + [了解 AEM 中的 Headless](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/overview.html?lang=zh-Hans)
          + [了解 CMS Headless 开发](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/learn-about.html?lang=zh-Hans)
          + [AEM Headless as a Cloud Service 快速入门](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/getting-started.html?lang=zh-Hans)
          + [首次 AEM Headless 使用体验的路径](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/path-to-first-experience.html?lang=zh-Hans)
          + [如何将内容建模为 AEM 内容模型](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/model-your-content.html?lang=zh-Hans)
          + [如何通过 AEM 传递 API 访问您的内容](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/access-your-content.html?lang=zh-Hans)
          + [如何通过 AEM Assets API 更新您的内容](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/update-your-content.html?lang=zh-Hans)
          + [如何融于一起](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/put-it-all-together.html?lang=zh-Hans)
          + [如何使用 Headless 应用程序上线](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/go-live.html?lang=zh-Hans)
          + [可选——如何使用 AEM 创建单页面应用程序](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/create-spa.html?lang=zh-Hans)
      ...
      + 内容片段{#content-fragments}
        + [使用内容片段和 GraphQL 进行 Headless 传递](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-graphql.html?lang=zh-Hans)
        + [使用内容片段](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments.html?lang=zh-Hans)
        + [为您的实例启用内容片段功能](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-configuration-browser.html?lang=zh-Hans)
        + [内容片段模型](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-models.html?lang=zh-Hans)
        + [管理内容片段](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-managing.html?lang=zh-Hans)
        + [变体——创作片段内容](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-variations.html?lang=zh-Hans)
        + [Markdown](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-markdown.html?lang=zh-Hans)
        + [使用关联内容](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-assoc-content.html?lang=zh-Hans)
        + [元数据——片段属性](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-metadata.html?lang=zh-Hans)
        + [结构树](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-structure-tree.html?lang=zh-Hans)
        + [预览——JSON 展现方案](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-json-preview.html?lang=zh-Hans)
      + 传递 API{#delivery-api}
        + [Assets HTTP API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/mac-api-assets.html?lang=zh-Hans)
        + [内容片段 REST API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/assets-api-content-fragments.html?lang=zh-Hans)
        + [内容片段GraphQL API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-api-content-fragments.html?lang=zh-Hans)
        + [管理 GraphQL 端点](/help/sites-developing/headless/graphql-api/graphql-endpoint.md)
        + [使用 GraphiQL IDE](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphiql-ide.html?lang=zh-Hans)
        + [持久查询](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/persisted-queries.html?lang=zh-Hans)
        ...
        + [对内容片段的远程 AEM GraphQL 查询的身份验证](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-authentication-content-fragments.html?lang=zh-Hans)
        + [带内容片段的AEM GraphQL API — 示例内容和查询](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/content-fragments-graphql-samples.html?lang=zh-Hans)
    ...
    + 混合和 SPA AEM 开发 {#spas}
      ...
      + [为组件启用 JSON 导出](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/components/json-exporter-components.html?lang=zh-Hans)
    ...
    + 扩展 AEM {#extending-aem}
      ...
      + 扩展经典 UI{#extending-classic-ui}
        ...
        + [开发报告](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/platform/dev-reports.html?lang=zh-Hans)
    + 测试 {#testing}
      ...
      + [测试您的 UI](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/components/hobbes.html?lang=zh-Hans)
    + 最佳做法 {#bestpractices}
      + [最佳做法概述](/help/sites-developing/best-practices.md)
      + [AEM开发准则和最佳实践](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/introduction/dev-guidelines-bestpractices.html?lang=zh-Hans)
      ...
      + [自定义命名空间](/help/sites-developing/custom-namespaces.md)
  ...
  + 部署 {#deploying}
    + AEM 平台简介 {#introduction}
      ...
      + [AEM中的存储元素](/help/sites-deploying/storage-elements-in-aem-6.md)
    ...
    + 部署 AEM {#deploying}
      ...
      + [为AEM脱机重新编制索引](/help/sites-deploying/offline-reindexing.md)
    ...
    + 升级到AEM 6.5 LTS {#upgrading}
      ...
      + {hide-from-toc}[使用模式检测器评估升级复杂性](/help/sites-deploying/pattern-detector.md)
      + [使用AEM Analyzer评估升级复杂性](/help/sites-deploying/aem-analyzer.md)
      + {hide-from-toc}[在AEM 6.5 LTS中向后兼容](/help/sites-deploying/backward-compatibility.md)
      + [升级流程](/help/sites-deploying/upgrade-procedure.md)
      + [执行就地升级](/help/sites-deploying/in-place-upgrade.md)
      + {hide-from-toc}[延迟内容迁移](/help/sites-deploying/lazy-content-migration.md)
      + {hide-from-toc}[使用CRX2Oak迁移工具](/help/sites-deploying/using-crx2oak.md)
      + [使用Oak将AEM 6.5迁移到AEM 6.5 LTS内容](/help/sites-deploying/aem-65-to-aem-65lts-content-migration-using-oak-upgrade.md)
      ...
      + {hide-from-toc}[正在升级自定义搜索Forms](/help/sites-deploying/upgrading-custom-search-forms.md)
      + {hide-from-toc}[可持续升级](/help/sites-deploying/sustainable-upgrades.md)
      ...
      + [应用程序服务器安装的升级步骤(WLP)](/help/sites-deploying/app-server-upgrade-wlp.md)
      + [应用程序服务器安装的升级步骤(Tomcat - Sidegrade)](/help/sites-deploying/app-server-upgrade-tomcat.md)
      + [应用程序服务器安装的升级步骤（Tomcat — 就地升级）](/help/sites-deploying/app-server-upgrade-tomcat-inplace.md)
