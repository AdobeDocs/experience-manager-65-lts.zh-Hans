...
+ 安全性 {#security}
   ...
   + [安全检查清单](/help/sites-administering/security-checklist.md)
   ...
   + [SameSite Cookie 支持](/help/sites-administering/same-site-cookie-support.md)
...
+ Sites {#sites}
   ...
   + 管理  {#administering}
      ...
      + 运维 {#operations}
         ...
         + [配置版面容器和版面模式](/help/sites-administering/configuring-responsive-layout.md)
      ...
      + 集成 {#integration}
         ...
         + [Flash 查看器生命周期终止通知](/help/sites-administering/flash-viewers-eol.md)
         ...
         + [与 BrightEdge 内容优化器集成](/help/sites-administering/brightedge.md)
         ...
         + [与外部服务商集成的 Analytics](/help/sites-administering/external-providers.md)
      ...
      + 最佳做法 {#bestpractices}
         ...
         + [MSM 最佳做法](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/administering/introduction/msm-best-practices.html?lang=zh-Hans)
         + [AEM Sites - GDPR 就绪性](/help/sites-administering/gdpr-compliance-sites.md)
         ...
         + [AEM Commerce - GDPR 就绪性](/help/sites-administering/gdpr-compliance-commerce.md)
      + 内容管理 {#contentmanagement}
         + [软件包管理器](/help/sites-administering/package-manager.md)
...
+ Assets {#assets}
   ...
   + [ [!DNL Assets] 中的无障碍功能](/help/assets/accessibility.md)
   + 使用 Experience Manager Assets {#using}
      ...
      + [通过  [!DNL Sites] 使用 Connected Assets](/help/assets/use-assets-across-connected-assets-instances.md)
   + Dynamic Media{#dynamic}
      ...
      + [从 Dynamic Media - Hybrid 模式迁移到 Dynamic Media - S7 模式](/help/assets/migrate-from-hybrid-to-dms7.md)
   ...
   + 管理 Assets {#administer}
      ...
      + [Assets 尺寸指南](/help/assets/assets-sizing-guide.md)
      ...
      + [Assets 中的 Digital Rights Management](/help/assets/drm.md)
...
+ Forms {#forms}
   ...
   + 快速入门 {#getting-started}
      ...
      + 教程：创建您的第一个自适应表单 {#create-first-adaptive-form}
         + [教程：创建第一个自适应表单](/help/forms/using/create-your-first-adaptive-form.md)
      ...
      + AEM Forms 参考资料 {#aem-forms-reference-collaterals}
         + [设置并配置 We.Gov 和 We.Finance 参考站点](/help/forms/using/forms-install-configure-gov-reference-site.md)
         + [We.Gov 和 We.Finance 参考站点演示](/help/forms/using/forms-gov-reference-site-user-demo.md)
         + [员工招聘参考站点演示](/help/forms/using/employee-recruitment-reference-site.md)
         + [We.Finance 汽车保险续保参考站点](/help/forms/using/finance-auto-insurance-renewal-reference-site-walkthrough.md)
         + [We.Gov 参考站点 FOIA 演示](/help/forms/using/gov-reference-site-foia-walkthrough.md)
         + [参考自适应表单片段](/help/forms/using/reference-adaptive-form-fragments.md)
         + [参考主题](/help/forms/using/reference-themes.md)
         + [参考信函模板](/help/forms/using/reference-cm-layout-templates.md)
         + [为 We.Finance 参考站点的住房按揭工作流配置 Microsoft Dynamics 365](/help/forms/using/ms-dynamics-configuration-home-mortgage.md)
   + 安装和配置 AEM Forms {#install-aem-forms}
      ...
      + 在 OSGi 上安装 AEM Forms {#osgi-installation}
         + [在 OSGi 上支持的平台](/help/forms/using/supported-platforms.md)
         ...
         + [在 OSGi 上安装和配置以表单为中心的工作流](/help/forms/using/installing-configuring-forms-centric-workflow-on-osgi.md)
      ...
      + 配置 AEM Forms {#configure-aem-forms}
         ...
         + [配置 Microsoft SharePoint 连接器](https://help.adobe.com/en_US/AEMForms/6.1/SharePointConfig/index.html)
         + [将 AEM Forms 与 Adobe LiveCycle 进行连接](/help/forms/using/aem-livecycle-connector.md)
         + [将 AEM Forms 配置为将表单数据提交到 AEM Forms on JEE 流程](/help/forms/using/submit-form-data-livecycle-process.md)
   ...
   + 升级 AEM Forms {#upgrade-aem-forms}
      ...
      + [升级到 AEM 6.5 Forms on JEE](/help/forms/using/upgrade-forms-jee.md)
   + 管理 AEM Forms {#manage-administer-aem-forms}
      ...
      + 处理用户数据 {#handling-user-data}
         + [基于表单的 OSGi 工作流](/help/forms/using/forms-workflow-osgi-handling-user-data.md)
      ...
      + 强化 AEM Forms 环境 {#hardening-aem-forms-environment}
         ...
         + [AEM Forms on JEE 的通用安全注意事项](/help/forms/using/general-security-considerations.md)
         + [强化 AEM Forms on JEE 环境](/help/forms/using/hardening-aem-forms-jee-environment.md)
         + [为 AEM Forms on JEE 配置安全管理设置](/help/forms/using/configuring-secure-administration-settings-aem.md)
   ...
   + 交互式通信 {#interactive-communications}
      ...
      + [打印渠道与网页渠道](/help/forms/using/web-channel-print-channel.md)
   ...
   + 工作流 {#workflows}
      + [OSGi 上基于 Forms 的工作流](/help/forms/using/aem-forms-workflow.md)
      + [OSGi 上基于 Forms 的工作流——步骤参考](/help/forms/using/aem-forms-workflow-step-reference.md)
      + [为基于 AEM Forms 的工作流步骤动态选择用户或用户组](/help/forms/using/dynamically-select-a-user-or-group-for-aem-workflow.md)
      + [OSGi 上基于表单的 AEM 工作流以及 AEM Forms JEE 工作流的操作和功能](/help/forms/using/capabilities-osgi-jee-workflows.md)
      ...
      + [配置离开办公室设置](/help/forms/using/configure-out-of-office-settings.md)
   + AEM Forms 工作区 {#use-aem-forms-workspace}
      ...
      + [AEM Forms 工作区架构](/help/forms/using/html-workspace-architecture.md)
      ...
      + [更改界面配色方案](/help/forms/using/changing-color-scheme-interface.md)
      ...
      + [AEM Forms 工作区入门](/help/forms/using/getting-started-livecycle-html-workspace.md)
   ...
   + AEM Forms 应用程序 {#aem-forms-app}
      ...
      + [使用启动点](/help/forms/using/working-with-startpoints.md)
   ...
   + HTML5 Forms {#html5-forms}
      ...
      + [HTML5 Forms 的最佳做法](/help/forms/using/best-practices-for-html5-forms.md)
   ...
   + 信函与往来通信 {#letters-correspondences}
      ...
      + [创建信函](/help/forms/using/create-letter.md)
      ...
      + [信函与交互式通信的后处理](/help/forms/using/submit-letter-topostprocess.md)
      ...
      + [用于访问信函实例的 API](/help/forms/using/cm-apis-to-access-letter-instances.md)
      + [将创建通信用户界面与自定义门户集成](/help/forms/using/integrating-create-correspondence-ui-with-your-portal.md)
      + [在通信管理中使用自定义特殊字符](/help/forms/using/custom-special-characters.md)
      + [在信函 PDF 预览中添加自定义水印](/help/forms/using/custom-watermark.md)
      + [配置通信管理解决方案](/help/forms/using/configuring-a-cm-solution.md)
      + [在交互式通信和信函中使用内联条件与重复](/help/forms/using/cm-inline-condition.md)
   ...
   + 将 AEM Forms 与 Experience Cloud 解决方案集成 {#integrate-aem-forms-with-experience-cloud-solutions}
      ...
      + [使用云服务框架进行分析](/help/forms/using/configure-analytics-forms-documents.md)
      + [使用 Adobe Launch 进行分析](/help/forms/using/integrate-aem-forms-with-adobe-analytics.md)
   ...
   + 发布和处理 AEM Forms {#publish-process-aem-forms}
      ...
      + [AEM Forms 中的监控文件夹](/help/forms/using/watched-folder-in-aem-forms.md)
      ...
      + [创建或配置监视文件夹](/help/forms/using/creating-configure-watched-folder.md)
   ...
   + 文档安全 {#use-document-security}
      ...
      + [使用便携式保护库扩展受策略保护的 PDF 文档的 Reader 功能](/help/forms/using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
   ...
   + Forms Designer {#use-forms-designer}
      ...
      + 无障碍访问最佳做法 {#accessibility-best-practices}
   ...
   + 事务报告  {#transaction-reports}
      ...
      + AEM Forms on OSGi 的事务报告 {#transaction-reports-osgi}
         ...
         + [AEM Forms on OSGi 的可计费 API 列表](/help/forms/using/transaction-reports-billable-apis.md)
         ...
         + [AEM Forms on JEE 的可计费 API 列表](/help/forms/using/transaction-reports-billable-apis-jee.md)
         + [为自定义组件 API 记录事务](/help/forms/using/record-transaction-custom-component-jee.md)
   + AEM Forms on JEE 的管理员帮助 {#administrator-help}
      + 开始使用 {#get-started}
      ...
      + 管理端点 {#manage-endpoints}
         ...
         + [配置远程调用端点](/help/forms/using/admin-help/configuring-remoting-endpoints.md)
         + [配置监控文件夹端点](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
      ...
      + 运行状况监视器 {#health-monitor}
         ...
         + [优化运行状况监视器性能](/help/forms/using/admin-help/fine-tuning-health-monitor-performance.md)
      ...
      + AEM Forms 备份与恢复 {#aem-forms-backup-recovery}
         ...
         + [监控文件夹的备份策略](/help/forms/using/admin-help/backup-strategies-watched-folders.md)
   ...
   + 开发人员参考 {#developer-reference}
      ...
      + 使用 AEM Forms on JEE 进行编程 {#programming-aem-forms-jee}
         + AEM Forms on JEE 编程简介 {#introduction-programming-aem-forms-jee}
         ...
         + 使用 API 调用 AEM Forms on JEE {#invoking-aem-forms-jee-apis}
            ...
            + [使用远程调用调用 AEM Forms](/help/forms/developing/invoking-aem-forms-using-remoting.md)
         ...
         + 使用 API 执行服务操作 {#performing-service-operations-using-apis}
            ...
            + [组装 PDF Portfolio](/help/forms/developing/assembling-pdf-portfolios.md)
            ...
            + [渲染交互式 PDF Forms](/help/forms/developing/rendering-interactive-pdf-forms.md)
   ...
   + 旧版文档 {#legacy-documentation}
      + [在 AEM Forms on JEE 工作台中使用执行脚本服务生成 XML 数据](/help/forms/developing/building-xml.md)
      + [使用 AEM Forms on JEE 自定义 DSC 压缩和解压文件](/help/forms/developing/compressing-decompressing-custom-dsc.md)
      + [配置和排查 AEM Forms on JEE 服务器集群](/help/forms/developing/configure-server-cluster.md)
      + [在动态 PDF Forms 中生成和处理哈希值](/help/forms/developing/hashing-forms.md)
...
+ 实施 {#implementing}
   + 开发 {#developing}
      + 开发人员入门 {#introduction}
         ...
         + [创建功能完整的网站（Classic UI）](/help/sites-developing/website.md)
         + [设计与 Designer（Classic UI）](/help/sites-developing/designer.md)
      ...
      + 组件{#components}
         ...
         + Classic UI 组件{#classic-ui-components}
            + [开发 AEM 组件（Classic UI）](/help/sites-developing/developing-components-classic.md)
            + [使用和扩展小组件（Classic UI）](/help/sites-developing/widgets.md)
            + [使用 xtype（Classic UI）](/help/sites-developing/xtypes.md)
            + [开发表单（Classic UI）](/help/sites-developing/developing-forms.md)
      ...
      + Headless 体验管理 {#headless}
         ...
         + Headless 历程  {#journeys}
            + Headless 开发人员历程 {#developer}
               ...
               + [迈向首次使用 AEM Headless 的体验之路](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/path-to-first-experience.html?lang=zh-Hans)
               ...
               + [如何将其整合在一起](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/put-it-all-together.html?lang=zh-Hans)
               ...
               + [可选——如何使用 AEM 创建单页应用程序](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/create-spa.html?lang=zh-Hans)
            + Headless 内容架构师历程  {#architect}
               ...
               + [学习使用 AEM 进行 Headless 内容建模的基础知识](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/basics.html?lang=zh-Hans)
         ...
         + 内容片段{#content-fragments}
            + [使用内容片段和 GraphQL 进行 Headless 交付](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-graphql.html?lang=zh-Hans)
            ...
            + [变量 - 创作片段内容](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-variations.html?lang=zh-Hans)
         ...
         + 传递 API{#delivery-api}
            + [资产 HTTP API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/mac-api-assets.html?lang=zh-Hans)
            ...
            + [内容片段 GraphQL API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-api-content-fragments.html?lang=zh-Hans)
            ...
            + [持久化查询](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/persisted-queries.html?lang=zh-Hans)
            ...
            + [带内容片段的 AEM GraphQL API——示例内容和查询](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/content-fragments-graphql-samples.html?lang=zh-Hans)
         + Universal Editor  {#universal-editor}
            + [简介](/help/sites-developing/universal-editor/introduction.md)
      + AEM 混合模式与单页应用开发 {#spas}
         + [在 AEM 中的混合模式与单页应用](https://business.adobe.com/content/dam/dx/us/en/products/experience-manager/sites/headless-content-management-system/pdfs/aem-hybrid-architecture-wp-1-18-19.pdf)
      ...
      + 开发工具 {#devtools}
         ...
         + [使用 Maven 管理软件包](/help/sites-developing/vlt-mavenplugin.md)
      ...
      + 个性化 {#personlization}
         ...
         + ClientContext{#client-context}
            + [客户端上下文详情](/help/sites-developing/client-context.md)
            + [客户端上下文 JavaScript API](/help/sites-developing/ccjsapi.md)
      + 扩展 AEM {#extending-aem}
         ...
         + 扩展 Classic UI{#extending-classic-ui}
            + [自定义网站控制台（Classic UI）](/help/sites-developing/customizing-siteadmin.md)
            + [自定义欢迎控制台（Classic UI）](/help/sites-developing/customizing-the-welcome-console.md)
      ...
      + 测试 {#testing}
         ...
         + [检查清单](/help/sites-developing/checklists.md)
      ...
      + 最佳做法 {#bestpractices}
         ...
         + [AEM 开发指南与最佳做法](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/introduction/dev-guidelines-bestpractices.html?lang=zh-Hans)
   ...
   + 部署 {#deploying}
      + AEM Platform 简介 {#introduction}
         + [AEM Platform 简介](/help/sites-deploying/platform.md)
      ...
      + 部署 AEM {#deploying}
         ...
         + [Oak-run.jar 索引使用案例](/help/sites-deploying/oak-run-indexing-usecases.md)
      ...
      + 升级到AEM 6.5 LTS {#upgrading}
         ...
         + [AEM 6.5 LTS中的向后兼容性](/help/sites-deploying/backward-compatibility.md)
...
+ 管理 {#managing}
   + 管理——最佳做法检查清单 {#managing-best-practices-checklist}
      + [项目管理——最佳做法检查清单](/help/managing/best-practices.md)
      + [检查清单](/help/managing/best-practices-checklist.md)
      + [术语表](/help/managing/best-practices-glossary.md)
      + [检查清单——更多参考](/help/managing/best-practices-further-reference.md)
   + 管理——更多参考 {#managing-further-reference}
      + [硬件规模指南](/help/managing/hardware-sizing-guidelines.md)
