...
description: 了解如何使用We.Retail在Adobe Experience Manager中使用核心组件。
contentOwner: User
...
1. 使用`We.Retail`示例内容启动Adobe Experience Manager (AEM)并打开[组件控制台](/help/sites-authoring/default-components-console.md)。
...
1. 所有核心组件都使用&#x200B;**v1**&#x200B;名称来指示每个组件的第一个版本。 计划在未来发布常规版本，这些版本与AEM的版本兼容，允许轻松升级，以便您能够利用最新功能。
1. 单击&#x200B;**文本(v1)**。
...
1. 利用核心组件，模板作者可以配置哪些属性可供页面作者使用。 这些属性包括允许粘贴源、格式选项和可用段落样式等功能。
