...
* Oracle Java™ 17/21（64位）(有关更多详细信息，请参阅有关[Java支持](#java-support)部分的更多详细信息。
...
### 离线压缩后在线压缩期间存储库损坏(GRANITE-65146)
...
规划应用时的实例停机时间。 若要离线压缩，请使用相应的[oak-run jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar)，该变量也在Software Distribution上提供。

>[!NOTE]
>
> 对于任何oak-run操作，请使用[oak-run 1.78.1-B006 jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar)（上面链接）。
