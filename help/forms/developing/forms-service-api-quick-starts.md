...
description: 了解如何使用Java&amp；trade； API渲染交互式PDF、HTML Forms和片段。
contentOwner: admin
...
[快速入门(SOAP模式)：使用Java处理作为XML提交的PDF forms](forms-service-api-quick-starts.md#quick-start-soap-mode-handling-pdf-forms-submitted-as-xml-using-the-java-api)
...
[快速入门(SOAP模式)：使用Java处理作为XML提交的HTML表单](forms-service-api-quick-starts.md#quick-start-soap-mode-handling-html-forms-submitted-as-xml-using-the-java-api)

[快速入门(SOAP模式)：使用Java创建包含提交的XML数据的PDF文档](forms-service-api-quick-starts.md#quick-start-soap-mode-creating-pdf-documents-with-submitted-xml-data-using-the-java-api)
