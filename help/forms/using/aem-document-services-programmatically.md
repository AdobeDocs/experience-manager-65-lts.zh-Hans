...
* 下载并使用AEM Forms maven项目配置[AEM客户端SDK](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases)。 该网站上提供了使用AEM Document Services构建Maven项目所需的客户端类。
