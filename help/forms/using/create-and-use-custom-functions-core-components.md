...
您可以向使用AEM项目原型[创建的项目](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-core-components/using/developing/archetype/using#getting-started)中添加客户端库，从而添加自定义函数。
