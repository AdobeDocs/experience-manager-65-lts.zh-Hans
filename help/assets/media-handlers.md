...
* 使用ImageMagick （`https://www.imagemagick.org/script/index.php`网站）和[Ghostscript](https://www.ghostscript.com/)的EPS和AI转换。
...
1. 安装[!DNL ImageMagick]：请参阅`https://www.imagemagick.org/script/download.php`网站上的ImageMagick文档。
